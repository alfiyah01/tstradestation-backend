...
const io = socketIo(server, {
    cors: {
        origin: ["https://zenphyrondigital.netlify.app", "http://localhost:3000", "http://127.0.0.1:5500", "http://localhost:5500"],
        methods: ["GET", "POST"],
        credentials: true
    },
...
app.post('/api/admin/contracts/generate', authenticateToken, requireAdmin, async (req, res) => {
    try {
        ...
        const contractLink = `${process.env.FRONTEND_URL || 'https://zenphyrondigital.netlify.app'}/contract/${accessToken}`;
